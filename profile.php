              ...
              <div class="d-flex align-items-center justify-content-between
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="avatar-xxl avatar-indicators avatar-online me-2
                    ...
                    <img src="assets/images/png/placeholder.png" class="avatar-xxl
                    ...
                    <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                      ...
                      <div class="avatar-group me-2">
                        ...
                        <span class="avatar avatar-sm">
                            <img alt="avatar"
                              src="assets/images/png/placeholder.png"
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between mb-5
                    ...
                    <div class="d-flex align-items-center">
                      <div>
                        <img src="assets/images/png/placeholder.png" alt="" class="avatar avatar-md rounded-circle">
                      </div>
                      <div class="ms-3">
                  ...
                  <div class="mb-4">
                    ...
                    <img src="assets/images/png/placeholder.png" class="rounded-3 w-100" alt="">
                  </div>
                  <!-- icons -->
                  <div class="mb-4">
                  ...
                  <div class="row">
                    <div class="col-xl-1 col-lg-2 col-md-2 col-12 mb-3 mb-lg-0">
                      <!-- avatar -->
                      <img src="assets/images/png/placeholder.png" class="avatar avatar-md rounded-circle" alt="">
                    </div>
                    <!-- input -->
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between
                    ...
                    <div class="d-flex align-items-center">
                      <!-- img -->
                      <div>
                        <img src="assets/images/png/placeholder.png" class="rounded-circle avatar-md" alt="">
                      </div>
                      <!-- text -->
                      <div class="ms-3 ">
